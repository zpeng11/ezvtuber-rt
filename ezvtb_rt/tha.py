...
class THA(): #Cached implementation of tensorrt tha core
    ...
    def inference(self, pose:np.ndarray) -> List[np.ndarray]: #This inference is running in a synchronized way
